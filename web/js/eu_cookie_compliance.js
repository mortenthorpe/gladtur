...
function displayNotification(c_action) {
    ...
    message = message + "<div id='cookie_html'><INPUT TYPE='button' class='submit buttony yellowbutton' VALUE='OK til cookies' onClick='JavaScript:doAccept();' style='padding:6px' /><div style='display:block;float:left;width:780px;'><div style='display:block;padding-left:20px'><p>På gladtur.dk bruger vi cookies til at huske dine indstillinger,<br/> så vi kan give dig den bedste oplevelse her på siden.</p><br/></div></div></div>";

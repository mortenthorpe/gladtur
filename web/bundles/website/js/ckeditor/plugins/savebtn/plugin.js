    ...
    init: function( editor ) {
        editor.addCommand( 'savecontent', {
        	...
        	exec : function(editor){
                ...
                var basePath = '/bundles/website/js/ckeditor/';
                //path to the ajaxloader gif
                loading_icon=basePath+'plugins/savebtn/icons/loader.gif';
                ...
                .done(function(response) {
                    //$('#'+editor.name).before('<div class="absoluted notice msg-saved">Dine redigeringer er gemt!</div>');
                    alert('Dine redigeringer er gemt!');
                })
                .fail(function() {
                })
                .always(function() {
